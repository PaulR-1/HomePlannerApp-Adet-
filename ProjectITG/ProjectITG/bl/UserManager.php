...
require_once "../model/userModel.php";
    class UserManager 
    {
            ...
            public function loginUserFunc($LoginFirstName, $LoginLastName, $LoginSelect)
            {
                ...
                if($fNameResult != "" && $lNameResult != "" && $lHomeName =="0")
                    {
                       echo 1;
                    }
                    else if($fNameResult != "" && $lNameResult != "" && $lHomeName =="1") {
                        echo 2;
                    }
                    else if($fNameResult != "" && $lNameResult != "" && $lHomeName =="2") {
                        echo 3;
                    }
                    else if($fNameResult != "" && $lNameResult != "" && $lHomeName =="3") {
                        echo 4;
                    }
            }
    }
